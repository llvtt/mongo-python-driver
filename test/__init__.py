...
from bson.py3compat import text_type, u
import pymongo
...
host = text_type(os.environ.get("DB_IP", 'localhost'))
port = int(os.environ.get("DB_PORT", 27017))
pair = '%s:%d' % (host, port)

host2 = text_type(os.environ.get("DB_IP2", 'localhost'))
port2 = int(os.environ.get("DB_PORT2", 27018))

host3 = text_type(os.environ.get("DB_IP3", 'localhost'))
